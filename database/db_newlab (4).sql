...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Nov 2023 pada 03.50
...
--
-- Struktur dari tabel `tbl_consult_answer`
--

CREATE TABLE `tbl_consult_answer` (
  `consult_answer_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `consult_question_id` int(11) NOT NULL,
  `consult_answer_text` text NOT NULL,
...
(10, 'ChindyElfianaSN ', 'chindyelfiana@gmail.com', 'chindyelfiana@gmail.com', 'chindyelfiana@gmail.com', '', '0000-00-00 00:00:00', '2023-11-23 15:31:16', 4);
...
--
-- Indeks untuk tabel `tbl_consult_answer`
--
ALTER TABLE `tbl_consult_answer`
  ADD PRIMARY KEY (`consult_answer_id`);
...
--
-- AUTO_INCREMENT untuk tabel `tbl_consult_answer`
--
ALTER TABLE `tbl_consult_answer`
  MODIFY `consult_answer_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tbl_log`
  MODIFY `log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1344;
...
--
ALTER TABLE `tbl_sim_question`
  MODIFY `sim_question_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT untuk tabel `tbl_sim_q_option`
--
ALTER TABLE `tbl_sim_q_option`
  MODIFY `sim_q_option_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
