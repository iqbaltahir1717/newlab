...
class User extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->session->userdata('user_id') == 1) {
            ...
            $data['user']    = $this->m_user->get_doctor();
            $data['group']   = $this->m_group->get(3);
        }
    ...
    public function create()
    {
        ...
        $data['user_spesialis']     = $this->input->post('user_spesialis');
        // $data['user_category']     = $this->input->post('user_category');
        $data['user_lastlogin'] = '';
        $data['user_photo']     = '';
