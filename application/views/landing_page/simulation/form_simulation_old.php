	                            ...
	                            <?php } elseif ($key->sim_question_type == 'file') { ?>
	                                <div class="row align-items-end">
	                                    <div class="form-group col-lg-10">
	                                        <label for=""><b><?= $key->sim_question_text ?> <span>*</span></b></label>
	                                        <input id="upload_image" accept=".jpeg, .png, .jpg" type="file" class="form-control form-control-xl" style="height:auto !important; padding:12px !important" name="response<?= $no ?>" placeholder="Enter <?= $key->sim_question_text ?> " required>
	                                    </div>
