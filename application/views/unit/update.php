                                            ...
                                            <div class="col-lg-5">
                                                ...
                                                <div class="row"> 
                                                    ...
                                                    <div class="mb-3 form-group">
                                                        ...
                                                        <textarea class="form-control" id="dark" name="unit_description" placeholder="Enter Description" rows="16" required="required"><?= $unit[0]->unit_description ?></textarea>
                                            ...
                                            <div class="col-lg-5">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3 form-group">
                                                        ...
                                                        <input type="file" class="form-control" placeholder="Cover/Thumbnail Unit" name="unit_preview1" accept=".png, .jpeg, .jpg, .webp, .avif">
                                                    ...
                                                    <div class="mb-3 form-group">
                                                        ...
                                                        <input type="file" class="form-control" placeholder="Cover/Thumbnail Unit" name="unit_preview2" accept=".png, .jpeg, .jpg, .webp, .avif">
