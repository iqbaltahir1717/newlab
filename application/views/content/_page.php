                    ...
                    <div class="row p-4">
                        ...
                        <div class="col-12">
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Title News" required="required" value="<?php echo $content[0]->content_title;?>" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" placeholder="Foto Kepala Puskesmas" name="content_image" accept=".png, .jpeg, .jpg, .avif, .webp">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" placeholder="Foto Struktur Organisasi" name="content_image" accept=".png, .jpeg, .jpg, .avif, .webp">
