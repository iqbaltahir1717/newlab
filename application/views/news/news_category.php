                    ...
                    <div class="row me-4 mt-4">
                        <div class="col-md-12 col-12 text-end">
                            <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#FormAdd"><i class="fas fa-plus"></i>
                                    Add
                            </button>
                            <a href="<?php echo site_url('news_category')?>" class="btn btn-success btn-sm" title="Refresh"><i class="bi bi-arrow-clockwise"></i> refresh</a>
                        </div>
                            <!-- Modal Add News Category -->
                            <div class="modal fade text-start" id="FormAdd" tabindex="-1" role="dialog"
                                aria-labelledby="myModalLabel33" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                    role="document">
                                    <div class="modal-content">
                                        <div class="modal-header bg-info">
                                            <h4 class="modal-title" id="myModalLabel33">Form Add Information Category</h4>
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label for="gallery_name">Information Category Name<span style="color:red">*</span></label>
                                                        <?php echo csrf();?>
                                                        <input type="text" class="form-control" placeholder="Information Category Name" name="news_category_name" required="required">
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover" id="table1">
                                    <thead>
                                        <tr>
                                            <th>No.</th>
                                            <th>Information Category Name</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        ?>
                                                ...
                                                <div class="modal fade text-start" id="FormDetail<?php echo $key->news_category_id?>" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header bg-info">
                                                                <h4 class="modal-title" id="myModalLabel33">Form Information Category Details</h4>
                                                                <button type="button" class="close" data-bs-dismiss="modal"
                                                                    aria-label="Close">
                                                                    <i data-feather="x"></i>
                                                                </button>
                                                            ...
                                                            <form>
                                                                 <div class="modal-body">
                                                                    <div class="row">
                                                                        <div class="form-group">
                                                                            <b>Information Category Name :</b> <br>
                                                ...
                                                <div class="modal fade text-start" id="FormUbah<?php echo $key->news_category_id?>" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header bg-info">
                                                                <h4 class="modal-title" id="myModalLabel33">Form Update Information Category</h4>
                                                                <button type="button" class="close" data-bs-dismiss="modal"
                                                                    aria-label="Close">
                                                                    <i data-feather="x"></i>
                                                                </button>
                                                                 ...
                                                                 <div class="modal-body">
                                                                    <div class="row">
                                                                            <div class="form-group">
                                                                                <label for="gallery_name">Information Category Name <span style="color:red">*</span></label>
                                                                                <?php echo csrf();?>
                                                                                <input type="text" class="form-control" placeholder="Information Category Name" name="news_category_name" required="required" value="<?php echo $key->news_category_name;?>">
                                                                                <input type="hidden" class="form-control" name="news_category_id" required="required" value="<?php echo $key->news_category_id;?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
