                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-9">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" class="form-control" name="gallery_cover" required="required" accept=".png, .jpeg, .jpg, .avif, .webp">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-9">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="file" class="form-control" name="gallery_cover" accept=".png, .jpeg, .jpg, .avif, .webp">
