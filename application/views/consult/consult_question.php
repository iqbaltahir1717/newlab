                ...
                <div class="card-content">
                    <div class="row me-4 mt-4">
                        <div class="col-md-12 col-12 text-end">
                            ...
                            <a href="<?php echo site_url('consult_question') ?>" class="btn btn-success btn-sm" title="Refresh"><i class="bi bi-arrow-clockwise"></i> refresh</a>
                        </div>
                        ...
                        <div class="modal fade text-start" id="FormAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
                            <div class="modal-dialog " role="document">
                                <div class="modal-content">
                                    ...
                                    <?php echo form_open("consult_question/create") ?>
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="form-group">
                                                <label for="gallery_name">Text<span style="color:red">*</span></label>
                                                <?php echo csrf(); ?>
                                                <input type="text" class="form-control" placeholder="Consultation questions Text" name="consult_question_text" required="required">
                                            </div>
                                ...
                                <table class="table table-hover" id="table1">
                                    ...
                                    <tbody>
                                        ...
                                        if ($consult_question) {
                                            $nox = 1;
                                            $no = 1;
                                            foreach ($consult_question as $key) {

                                        ?>
                                                <tr>
                                                    <td><?php echo $no; ?></td>
                                                    <td><?php echo $key->consult_question_text; ?></td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group dropstart mb-1">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <button type="submit" class="dropdown-item" data-bs-toggle="modal" title="Lihat data" data-bs-target="#FormDetail<?php echo $key->consult_question_id; ?>"><i class="bi bi-eye"></i> Detail</button>
                                                                </li>
                                                                <li>
                                                                    <button type="submit" class="dropdown-item" data-bs-toggle="modal" title="Ubah data" data-bs-target="#FormUbah<?php echo $key->consult_question_id; ?>"><i class="bi bi-pencil-square"></i> Ubah</button>
                                                                </li>
                                                                <li>
                                                                    <?php echo form_open_multipart("consult_question/delete") ?>
                                                                    <?php echo csrf(); ?>
                                                                    <button type="submit" class="dropdown-item" title="Delete data"><i class="bi bi-x-lg"></i> Delete</button>
                                                                    <input type="hidden" class="form-control" name="consult_question_id" required="required" value="<?php echo $key->consult_question_id; ?>">
                                                                    <?php echo form_close(); ?>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                ...
                                                <!-- Modal Detail consult_question -->
                                                <div class="modal fade text-start" id="FormDetail<?php echo $key->consult_question_id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
                                                            ...
                                                            <form>
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        <div class="form-group">
                                                                            <b>Text :</b> <br>
                                                                            <?php echo $key->consult_question_text; ?>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <b>Type :</b> <br>
                                                                            <?php echo $key->consult_question_type; ?>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <b>Multiple :</b> <br>
                                                                            <?php echo $key->consult_question_multi; ?>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="modal fade text-start" id="FormUbah<?php echo $key->consult_question_id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header bg-info">
                                                            ...
                                                            <?php echo form_open("consult_question/update"); ?>
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <?php echo csrf(); ?>
                                                                    <div class="form-group">
                                                                        <label for="consult_question_text">Text<span style="color:red">*</span></label>
                                                                        <input type="text" class="form-control" placeholder="Consultation questions Text" name="consult_question_text" required="required" value="<?php echo $key->consult_question_text; ?>">
                                                                        <input type="hidden" class="form-control" name="consult_question_id" required="required" value="<?php echo $key->consult_question_id; ?>">
                                                                        <input type="hidden" class="form-control" name="aaaaa" required="required" value="<?php echo $key->consult_question_id; ?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for=""><b>Type <span style="color:red">*</span></b></label>
